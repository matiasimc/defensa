...
\begin{frame}[fragile]{Inferencia Global vs Inferencia Local}
  ...
  \end{onlyenv}
  \only<4>{Mucho trabajo para el programador!}
...
\begin{frame}[fragile]{Inferencia Global Restringida}
  ...
  \begin{itemize}
    ...
    \uncover<4->{\item Si el tipo de retorno de un método es $\bot$, entonces cualquier asignación $e1 = e2.m(e3)$ será válida, puesto que  $\bot <: t1$. Además, si lo usamos como argumento, también cualquier expresión $e1.m1(e2.m2(e3))$ será valida.}
  \end{itemize}
