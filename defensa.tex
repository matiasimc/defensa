...
\begin{frame}[fragile]{Descripción y motivación del problema}
  \begin{itemize}
...
\begin{frame}[fragile]{Propuesta: Proceso iterativo de inferencia asistida}
	\begin{itemize}
		\uncover<1->{\item Paso 1: Inferir considerando solo las facetas de la firma de un metodo que están definidas.}
		\uncover<2>{\item Pasos sucesivos: Utilizando las facetas inferidas en el paso 1 y las modificaciones del usuario, refinar las facetas cuando sea pertinente.}
	\end{itemize}
\end{frame}
\begin{frame}[fragile]{Propuesta: Proceso iterativo de inferencia asistida}
